    ...
    switch ($_POST['action']) {
      ...
      case 'update':
        if (isset($_POST['id']) && isset($_POST['name']) && isset($_POST['lastname']) && isset($_POST['email']) && isset($_POST['phone_number']) && isset($_POST['created_by']) && isset($_POST['role']) && isset($_POST['created_by']) && isset($_POST['password'])) {
          ...
          $user = new UserController();
          $user->updateUsers($id, $name, $lastname, $email, $phone_number, $role, $created_by, $password);
        } else {
          header('location: '.BASE_PATH.'users?error=false');
        }
        break;
...
class UserController {
  ...
  public function create($name, $lastname, $email, $phone_number, $role, $created_by, $password, $imagen) {
  ...
  public function updateUsers($id, $name, $lastname, $email, $phone_number, $role, $created_by, $password){
    $token = $_SESSION['token'];
    $curl  = curl_init();
