                                        ...
                                        <div class="row g-4">
                                            <div class="col-sm-auto">
                                                <div>
                                                    ...
                                                    <button type="button" class="btn btn-success btn-label waves-effect waves-light rounded-pill"><i class="ri-add-line align-bottom me-1 label-icon align-middle rounded-pill fs-16 me-2"></i> Add Product</button>
                                                </div>
                                            </div>
                                            <div class="col-sm">
