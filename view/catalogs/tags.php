                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div>
                                <div class="card">
                                    <div class="card-header border-0">
                                        <div class="row g-4">
                                            <div class="col-sm-auto">
                                                <div>
                                                    <button onclick="addTag()" type="button" data-bs-toggle="modal" data-bs-target="#modalTag" class="btn btn-success btn-label waves-effect waves-light rounded-pill"><i class="ri-add-line align-bottom me-1 label-icon align-middle rounded-pill fs-16 me-2"></i> Add Tag</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!-- TABLA TAGS -->
                                    <div class="card-body">
                                        <table id="tableTags" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th scope="col">ID</th>
                                                        ...
                                                        <td>
                                                            <div class="dropdown ms-2">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                    <li><a class="dropdown-item" data-tag='<?php echo json_encode($item)?>' onclick="editTag(this)" data-bs-toggle="modal" data-bs-target="#modalTag" href="#">Edit</a></li>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-xxl-6">
                                <div>
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" onpaste="return false" onkeypress="return onlyLettersAndSpaces(event)" placeholder="Enter tag's name" required>
                                </div>
                            </div><!--end col-->
                            <div class="col-xxl-6">
                                <div>
                                    <label for="slugTag" class="form-label">Slug</label>
                                    <input type="text" class="form-control" id="slugTag" name="slugTag" onpaste="return false" onkeypress="return slug(event)" placeholder="Enter tag's slug" required>
                                </div>
                            </div><!--end col-->
...
<script>
    function remove (id) {
        ...
        if (willDelete) {
            ...
            axios.post('<?= BASE_PATH ?>tag', bodyFormData)
    ...
    function addTag() {
        ...
        document.getElementById("exampleModalgridLabel").innerHTML = "Add new tag";

        document.getElementById("name").value = "";
        document.getElementById("slugTag").value = "";
    ...
    function editTag(target) {
        ...
        document.getElementById("exampleModalgridLabel").innerHTML = "Edit tag";

        document.getElementById("name").value = tag.name;
        document.getElementById("slugTag").value = tag.slug;
